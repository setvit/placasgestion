...
use Yii;
use backend\models\TabPlacas;
use backend\models\TabPlacasSearch;
...
class TabPlacasController extends Controller
{
    ...
    if(Yii::$app->user->can( 'ver-placas' ))
        ...
        {
        throw new ForbiddenHttpException('No tienes los permisos para acceder a este recurso');
        }
    }
    ...
    {
    if(Yii::$app->user->can( 'borrar-placa' ))
        {
